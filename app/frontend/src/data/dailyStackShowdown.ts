...
const DAILY_ROTATION: RotationMatchup[] = [
  ...
  },
  {
    ...
    stackB: {
      ...
      name: 'Lifecycle newsletter stack',
      bestForLine: 'Best for teams that need reliable lifecycle sends with broad template support.',
      tradeOffLine: 'Trade-off: less creator-specific growth tooling than newsletter-first platforms.',
      tools: [
        { name: 'Mailchimp', logoUrl: 'https://logo.clearbit.com/mailchimp.com', websiteUrl: 'https://mailchimp.com' },
      ...
      summary: 'Lifecycle-friendly email execution for teams prioritizing consistency.',
      badges: ['Budget: High', 'Complexity: Medium'],
      rankingSignals: {
        toolSlugs: ['mailchimp', 'figma', 'hotjar'],
        budget: 'high',
        complexity: 'medium',
  ...
  },
  {
    ...
    stackA: {
      ...
      bestForLine: 'Best for teams focused on lead capture funnels and conversion flow ownership.',
      tradeOffLine: 'Trade-off: less design freedom than site-first builders.',
      tools: [
        { name: 'ClickFunnels', logoUrl: 'https://logo.clearbit.com/clickfunnels.com', websiteUrl: 'https://www.clickfunnels.com' },
        { name: 'Typeform', logoUrl: 'https://logo.clearbit.com/typeform.com', websiteUrl: 'https://www.typeform.com' },
        { name: 'Calendly', logoUrl: 'https://logo.clearbit.com/calendly.com', websiteUrl: 'https://calendly.com' },
      ],
      summary: 'Funnel-first stack optimized for conversion paths and lead capture.',
      badges: ['Complexity: Low', 'Best for: Validation'],
      rankingSignals: {
        toolSlugs: ['clickfunnels', 'typeform', 'calendly'],
        budget: 'mid',
        complexity: 'low',
        bestFor: 'funnel-conversion',
      },
    },
    stackB: {
